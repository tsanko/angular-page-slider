...
angular
	...
	.run(['$templateCache', function ($templateCache) {
		...
		$templateCache.put(
			...
			'<div class="slider" style="background-color: #eeeeee;" ng-cloak>' +
